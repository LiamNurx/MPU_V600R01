...
PATHINC += -I ./cmsis
PATHINC += -I ./cmsis/inc
PATHINC += -I C:\Keil_v5\ARM\ARMCC\include
PATHINC += -I C:\Keil_v5\ARM\PACK\ARM\CMSIS\5.0.1\CMSIS\Include
...
CMSISOBJS += ./cmsis/startup_hc32l13x.o
CMSISOBJS += ./cmsis/system_hc32l13x.o
CMSISOBJS += ./cmsis/interrupts_hc32l13x.o
CMSISOBJS +=

#	"片上外设层" 目标文件变量。新增使用外设时，在尾部添加即可。
CMSISSRCOBJS += ./cmsis/src/sysctrl.o
CMSISSRCOBJS += ./cmsis/src/gpio.o
CMSISSRCOBJS += ./cmsis/src/ddl.o

#	“功能应用层” 目标文件变量。新增模块功能时，在尾部添加即可。
APPOBJS += ./app/main.o
APPOBJS += ./app/app_uart.o
APPOBJS += 
...
#	在生成对应目标文件的同时得到对应的依赖关系文件，并拷贝至依赖文件目录下
%.o : %.c
